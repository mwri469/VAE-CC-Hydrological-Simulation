...
distributions with observed distributions by mapping quantiles from the modelled data, to 
quantiles 
in the observed data. When applied to future projections, the method assumes that 
...
Recent papers such as Chandel et al. \cite{Chandel_2024} challenge this approach.
They demonstrated that aggressive bias 
