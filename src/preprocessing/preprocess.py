...
class ClimateDataset(Dataset):
    ...
    def __init__(self, csv_path: str, config, scenario: str = 'historical'):
        self.config = config
        ...
        self.data, self.mask = self._load_data()
    ...
    def _load_data(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        for model in self.models:
            ...
            land_mask = ~np.isnan(ds_first_crop[self.config.VARIABLES[0]].values[0])
